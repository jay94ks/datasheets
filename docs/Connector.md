...
2. Unknown brand: [HC-TYPE-C 16PIN](/PDF/unknown/HC-TYPE-C%2016pin%200.8mm.pdf)
   ...
   5) Contact resistance `30m Ohm` max.
   6) Insulation resistance: `1kM ohm` min.
   7) Withstand voltage: `500V AC`.
   8) Durability: `??? cycles`.
...
3. Unknown brand: [TYPE-C 16PIN](/PDF/unknown/TYPE-C%2016pin%201.6mm.pdf)
   ...
   5) Contact resistance `40m Ohm` max.
   6) Insulation resistance: `100M ohm` min.
   7) Withstand voltage: `100V AC`.
   8) Durability: `5000 cycles`.
   9) https://ko.aliexpress.com/item/1005005555059450.html
